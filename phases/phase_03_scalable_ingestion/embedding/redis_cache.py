...
class EmbeddingCache:
    ...
    def get_doc_meta(self, doc_id: str) -> dict | None:
        from phases.phase_03_scalable_ingestion.embedding.fingerprint import deserialize_meta, meta_key
    ...
    def set_doc_meta(self, doc_id: str, fingerprint: str, chunk_keys: dict[str, str]) -> None:
        from phases.phase_03_scalable_ingestion.embedding.fingerprint import meta_key, serialize_meta
