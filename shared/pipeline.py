...
from shared.models import QueryRequest, QueryResponse, RetrievedContext
from phases.phase_01_multimodal_ingestion.embeddings.colpali_embedder import ColPaliEmbedder
from phases.phase_01_multimodal_ingestion.embeddings.image_embedder import ImageEmbedder
...
from phases.phase_01_multimodal_ingestion.retrieval.reranker import CrossEncoderReranker
from phases.phase_01_multimodal_ingestion.stores.qdrant_store import COLLECTION_MAP, QdrantStore, page_index_status
from phases.phase_02_long_doc_retrieval.ingest import Phase2IngestConfig, apply_phase2_ingest, invalidate_phase2_caches
...
class RAGPipeline:
    ...
    def ingest(self, path: str | Path) -> IngestResult:
        ...
        try:
            from phases.phase_06_production.guardrails.pii import redact_chunk_contents
        ...
        *,
        ...
        if not generate_answer:
            ...
            if self.config.use_taxonomy_validation:
                from phases.phase_04_taxonomy_generation.hooks import apply_conformity_check
