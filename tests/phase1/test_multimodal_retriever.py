...
from phases.phase_01_multimodal_ingestion.retrieval.multimodal_retriever import (
    MultiModalRetriever,
    _collection_weights,
    _dedupe_by_content,
...
def test_resolve_query_vector_falls_back_when_page_chunks_not_colpali():
    ...
    from phases.phase_01_multimodal_ingestion.retrieval.multimodal_retriever import _ModalitySearch
...
def test_hybrid_text_search_merges_page_chunks_when_not_colpali():
    ...
    import phases.phase_02_long_doc_retrieval.retrieval.hybrid_retriever as hybrid_mod
