...
from phases.phase_02_long_doc_retrieval.retrieval.hybrid_retriever import HybridRetriever, reciprocal_rank_fusion
from shared.models import ChunkType, DocumentChunk, DocumentType, QueryRequest, RetrievalStrategy
...
def test_boost_section_chunks_promotes_objectives_page():
    from phases.phase_02_long_doc_retrieval.retrieval.hybrid_retriever import _boost_section_chunks
